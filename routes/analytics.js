...
var session_disconnect = function(socket_id,fn){
      analytics_session.update({"socket_id":socket_id},{"exit_time":Date.now(),"active":false},function(err,result){
         if(err)
         {
...
module.exports.get_active_sessions = get_active_sessions;
